...
const SiteFooter = (props) => {
  const handleThing = () => console.log('handle thing. . .');

  const placeHolderData = props.rendering.placeholders['footer-navigation-column-1'];
    ...
    <footer className="site-footer">
      ...
      <div className="footer-navigation-container">
        <FooterNavigationColumn
          hello={placeHolderData}
          handleClick={() => console.log('handling the click. . .')}
        />
